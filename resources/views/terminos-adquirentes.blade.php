<x-layouts.guest>
    ...
    <div class="flex flex-col items-center min-h-[30vh] px-4">
        ...
        <div class="lg:px-24 px-4 flex flex-col gap-y-2  max-w-7xl">
            ...
            <p>
                13.- Casablanca.ar se reserva el derecho de rechazar el registro de El Adquirente, si así lo llegara
                a considerar. También puede excluir un lote de la subasta sin aviso previo. Los derechos de
                imagen de las fotografías, videos, audios o cualquier otro archivo digital de los bienes son
                propiedad de Casablanca.ar. La legitimidad de los lotes, en cuanto a origen, veracidad de firma o
                antigüedad surgen de los dichos de sus dueños o de los informes de los expertos consultados.
                Casablanca.ar no puede revelar la procedencia de los lotes salvo expresa autorización de sus
                dueños.
            </p>
            <p>
                14.- Si el El Adquirente se arrepintiera de su compra y no cumpliera con su obligación de
                abonarla, perderá el derecho a la devolución de la garantía y será considerado postor remiso de
                acuerdo a lo establecido en el art. 580 del CPCC y Casablanca.ar se reserva el derecho de
                emprender las acciones judiciales que considere, sentando jurisdicción en la Ciudad Autónoma
                de Buenos Aires.
            </p>
            <p>
                15.- El Adquirente se compromete a mantener su contraseña en secreto. De igual modo, se
                ...
                del Adquirente mantener la confidencialidad de la cuenta de usuario y de la contraseña, las
                cuales serán personales e intransferibles. El incumplimiento de las obligaciones facultará a
