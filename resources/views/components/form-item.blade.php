@props(['label' => '', 'method' => '', 'model' => '' ,'type'=>"text", "auto" => "false","step"=>"1" ,"min" =>0])
...
<div class="items-start  lg:w-auto w-[85%] mx-auto ">
    ...
    <div class="relative w-full">
        ...
        class="lg:w-60 h-6 rounded-md border border-gray-400 w-full text-gray-500 p-2 text-sm bg-gray-100" @disabled($method === "view")  />
        {{-- <x-input-error for={{ $model }} class="relative top-full py-0 leading-[12px]" /> --}}
