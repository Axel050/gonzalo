<footer class=" text-casa-base  md:mt-24 mt-16  g-red-300 flex flex-col w-full ">
    ...
    <div
        class="relative flex flex-col bg-casa-ondo  w-full justify-center md:px-16 xl:px-24     md:h-58  text-casa-black   z-10  ">

        <div
            class="max-w-8xl border border-casa-black  md:px-6 lg:px-10 xl:px-20 px-4 md:py-10 xl:py-12 py-8 relative bg-casa-base-2 self-center w-full">
          ...
          ¿Tenés <span class="font-librecaslon italic">amdo</span> para vender?
            ...
            <x-fancy-heading text="¿Te{n}és al{g}o p{a}ra v{e}n{d}er?"
                class=" md:text-[43px]   lg:text-[60px] xl:text-[64px] text-[37px] leading-9 text-start  md:mb-1 text-wrap" />
    ...
    <div class="relative flex flex-col bg-casa-black md:-mt-29 md:px-16 xl:px-24   ">

        <div
            class="flex flex-col bg-casa-black  w-full mx-auto justify-center  md:px-6 lg:px-10 xl:px-20 px-4   md:py-10 xl:py-12  md:h-58 md:mt-50 md:border border-b-1 border-x-casa-fondo-h py-8 max-w-8xl">
            ...
            <x-fancy-heading text="¿Te{n}és al{g}un{a} du{d}a?"
                class=" md:text-[43px]   lg:text-[60px] xl:text-[64px] text-[37px] leading-9 text-start  md:mb-1 text-wrap text-casa-base" />
