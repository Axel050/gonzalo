...
<div class="items-start  lg:w-auto w-[85%] mx-auto">
        ...
        <div class="pl-2"> 
                ...
                <div class="mt-0.5" >
                    ...
                    @php
                          $url = $foto && method_exists($foto, 'temporaryUrl') ? $foto->temporaryUrl() : ($foto ? Storage::url('imagenes/'.$folder.'/'.$foto) : asset('004b.jpg'));
                    @endphp
                                            
                  <img src="{{ $url }}" alt="Previsualización"   style="max-width: {{$w}}px; max-height: {{$h}}px; object-fit: cover; display: block;"       class="mx-auto border">
