@props(['titulo', 'envio', 'enlace' => 'text-gray-500 hover:text-casa-black'])
...
<div x-data="{ open: false }" class="inline-block g-amber-500   relative 2 z-40">
    ...
    <!-- Botón para abrir -->
    <button
        class="{{ $enlace }} group flex items-center md:gap-2 gap-1 md:text-sm text-xs font-medium  hover:text-black transition-colors mt-2  z-30"
        ...
        <span
            class="underline underline-offset-3 transition-colors
