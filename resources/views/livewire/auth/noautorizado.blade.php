...
<body class="bg-gray-950">
    ...
    <div class="min-h-screen flex items-center justify-center z-30">
        <div class="bg-linear-to-r from-cyan-800 to-cyan-950 p-8 rounded-lg shadow-md max-w-md w-full text-center z-30">
            ...
            <h1 class="text-2xl font-bold text-gray-200 mb-4">No autorizado</h1>
            <p class="text-gray-300 mb-6">Tu cuenta no tiene los permisos para ver esta pagina. Por favor contacta al
                administrador.</p>
