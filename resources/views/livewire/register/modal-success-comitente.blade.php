<div class="fixed  inset-0 flex items-center justify-center  z-50 animate-fade-in-scale cursor-pointer">
    ...
    <div
        class = 'border  border-gray-500   md:max-w-xl  lg:w-[40%] w-auto  x-auto  z-50  shadow-gray-400 shadow-md max-h-[95%] 
        ...
        <div
            ...
            <div class="flex text-casa-black justify-center lg:mt-12 mt-8 gap-10">
                <a href="{{ route('instructivo-comitentes') }}"
                    ...
                    <span class=" pb-1"> Primeros pasos</span>
