<div class="w-full py-5">
            ...
            <div class="overflow-hidden">
                ...
                <table class="min-w-full divide-y  divide-gray-600 ">
                    ...
                    <tbody class="divide-y divide-gray-400 text-gray-600  text-sm bg-gray-300">
                        ...
                        @forelse($liquidaciones as $factura)
                            <tr
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-10 text-gray-500 italic text-center">No se encontraron
                                    liquidaciones.</td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    @if ($method != '')
        @livewire('admin.liquidaciones.modal', ['id' => $id, 'method' => $method], key('modal-liquidacion-' . $id . '-' . $method))
    @endif
</div>
