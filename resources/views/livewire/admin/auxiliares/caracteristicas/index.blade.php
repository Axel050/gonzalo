<div class=" w-full  py-5">
    ...
    <x-action-message on="caracteristicaCreated" class="absolute  top-0 right-0 z-50 green-action ">Caracteristica creada
        con exitó.</x-action-message>
    <x-action-message on="caracteristicaUpdated" class="absolute  top-0 right-0 z-50 orange-action">Caracteristica
        actualizada con exitó.</x-action-message>
    <x-action-message on="caracteristicaDeleted" class="absolute  top-0 right-0 z-50 red-action">Caracteristica eliminada
        con exitó.</x-action-message>
    ...
    <div class="">
        ...
        @if ($method)
            @livewire('admin.auxiliares.caracteristicas.modal', ['method' => $method, 'id' => $id])
        @endif
