<div class="bg-gay-50 w-full  fullscreen py-5">
    ...
    <x-action-message on="estadoCreated" class="absolute  top-0 right-0 z-50 green-action ">Estado creado con
        exitó.</x-action-message>
    <x-action-message on="estadoUpdated" class="absolute  top-0 right-0 z-50 orange-action">Estado actualizado con
        exitó.</x-action-message>
    <x-action-message on="estadoDeleted" class="absolute  top-0 right-0 z-50 red-action">Estado eliminado con
        exitó.</x-action-message>
    ...
    <div class="">
        ...
        @if ($method)
            @livewire('admin.auxiliares.estado-adquirentes.modal', ['method' => $method, 'id' => $id])
        @endif
                            ...
                            <tbody class="divide-y divide-gray-400 text-gray-600  text-sm bg-gray-300">
                                ...
                                @foreach ($estados as $estado)
                                    <tr
                                        ...
                                        <td class="py-2">{{ $estado->id }}</td>
                                        <td class="py-2">{{ $estado->nombre }}</td>
                                        <td class="py-2">{{ $estado->descripcion }}</td>
                                        ...
                                        <td>
                                            <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('view',{{ $estado->id }})" title="Ver estado">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('delete',{{ $estado->id }})">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('update',{{ $estado->id }})">
                                                    <svg width="20px" height="20px" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
