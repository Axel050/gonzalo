<div class="w-full  py-5">
    ...
    <x-action-message on="condicionCreated" class="absolute  top-0 right-0 z-50 green-action ">Condicion creada con
        exitó.</x-action-message>
    <x-action-message on="condicionUpdated" class="absolute  top-0 right-0 z-50 orange-action">Condicion actualizada con
        exitó.</x-action-message>
    <x-action-message on="condicionDeleted" class="absolute  top-0 right-0 z-50 red-action">Condicion eliminada con
        exitó.</x-action-message>
    ...
    <div class="">
        ...
        @if ($method)
            @livewire('admin.auxiliares.condicion-iva.modal', ['method' => $method, 'id' => $id])
        @endif
                            ...
                            <tbody class="divide-y divide-gray-400 text-gray-600  text-sm bg-gray-300">
                                ...
                                @foreach ($condiciones as $condicion)
                                    <tr
                                        ...
                                        <td class="py-2">{{ $condicion->id }}</td>
                                        <td class="py-2">{{ $condicion->nombre }}</td>
                                        ...
                                        <td>
                                            <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('delete',{{ $condicion->id }})">
                                                    <svg class="size-5 mr-0.5">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('update',{{ $condicion->id }})">
                                                    <svg class="size-5 mr-0.5">
