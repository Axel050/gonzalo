<div class="w-full  py-5 ">
    ...
    <x-action-message on="motivoCreated" class="absolute  top-0 right-0 z-50 green-action ">motivo creado con
        exitó.</x-action-message>
    <x-action-message on="motivoUpdated" class="absolute  top-0 right-0 z-50 orange-action">motivo actualizado con
        exitó.</x-action-message>
    <x-action-message on="motivoDeleted" class="absolute  top-0 right-0 z-50 red-action">motivo eliminado con
        exitó.</x-action-message>
    ...
    <div class="">
        ...
        @if ($method)
            @livewire('admin.auxiliares.motivos.modal', ['method' => $method, 'id' => $id])
        @endif
                            ...
                            <tbody class="divide-y divide-gray-400 text-gray-600  text-sm bg-gray-300">
                                ...
                                @foreach ($motivos as $motivo)
                                    <tr
                                        ...
                                        <td class="py-2">{{ $motivo->id }}</td>
                                        <td class="py-2">{{ $motivo->nombre }}</td>
                                        <td class="py-2">{{ $motivo->descripcion }}</td>
                                        ...
                                        <td>
                                            <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('delete',{{ $motivo->id }})">
                                                    <svg class="size-5 mr-0.5">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('update',{{ $motivo->id }})">
                                                    <svg class="size-5 mr-0.5">
