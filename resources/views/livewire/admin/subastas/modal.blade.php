   <div class="fixed inset-0 flex items-center justify-center  z-50 "  >
          ...
          <div class="absolute  inset-0 bg-gray-600 opacity-70" wire:click="$parent.$set('method',false)"></div>              
            ...
            <div  class=" border  border-gray-500   md:max-w-md  lg:w-[40%] w-[90%] x-auto  z-50  shadow-gray-400 shadow-md max-h-[95%] 
                ...
                <div class="bg-gray-200  pb-6 text-gray-700  text-start rounded-xl ml-0">
                    <div class="flex  flex-col justify-center items-center  ">                             
                          ...
                          <form class="bg-red-80  w-full  flex flex-col gap-2 lg:text-lg  text-base lg:px-4 px-2 text-gray-200  [&>div]:flex
                            ...
                            @if ($method =="delete")
                             ...
                             @else
                                ...
                                <x-form-item label="Tiempo post subasta (min)" :method="$method" model="tiempoPos" type="number" step="1" min=0 />
                              ...
                              <div class="items-start  lg:w-auto w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full ">
                                  <input type="date" wire:model="iniD" class ="h-6 rounded-md border border-gray-400 w-40 text-gray-500 p-1 text-sm bg-gray-100"    @disabled($method === 'view') 
/>
                                  <input type="time" wire:model="iniH" class ="h-6 rounded-md border border-gray-400 w-20 text-gray-500 pl-1 text-sm bg-gray-100" @disabled($method === 'view') 
/>
                              ...
                              <div class="items-start  lg:w-auto w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full ">
                                  <input type="date" wire:model="finD" class ="h-6 rounded-md border border-gray-400 w-40 text-gray-500 p-1 text-sm bg-gray-100"    @disabled($method === 'view') 
/>
                                  <input type="time" wire:model="finH" class ="h-6 rounded-md border border-gray-400 w-20 text-gray-500 pl-1 text-sm bg-gray-100"  @disabled($method === 'view')
/>
                              ...
                              <div class="items-start  lg:w-auto w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full">
                                  <textarea   wire:model="descripcion"  class =" rounded-md border border-gray-400 w-60 text-gray-500 p-2 text-sm bg-gray-100"     @disabled($method === 'view') >
                                  </textarea>
                                  <x-input-error for="descripcion"   class="absolute top-full"/>
                                </div>
                              </div>
                              ...
                              <div class="items-start  lg:w-auto w-[85%] mx-auto ">
                                ...
                                <div class="relative w-full ">
                                    <select   wire:model.live="estado" class="h-6 rounded-md border border-gray-400 w-60 text-gray-500 text-sm py-0.5 bg-gray-100 pl-1 "    @disabled($method === 'view') >
