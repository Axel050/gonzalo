<div class="bg-gay-50 w-full  fullscreen py-5">
    ...
    <x-action-message on="personalCreated" class="absolute  top-0 right-0 z-50 green-action ">Personal creado con
        exitó.</x-action-message>
    <x-action-message on="personalUpdated" class="absolute  top-0 right-0 z-50 orange-action">Personal actualizado con
        exitó.</x-action-message>
    <x-action-message on="personalDeleted" class="absolute  top-0 right-0 z-50 red-action">Personal eliminado con
        exitó.</x-action-message>

    <div class="z-50">
        <div
            class="w-full flex item-center justify-between order-4  lg:flex-row lg:items-center  mx-auto bg-gray-300 lg:py-4  py-2 lg:px-6 px-3 rounded-md  shadow-md z-10 ">
        ...
        @if ($method)
            @livewire('admin.personal.usuarios.modal', ['method' => $method, 'id' => $id])
        @endif
                                        ...
                                        <td>
                                            <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('delete',{{ $car->id }})">
                                                ...
                                                <button
                                                    ...
                                                    wire:click="option('update',{{ $car->id }})">
                                                    <svg width="20px" height="20px" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
