<div class="bg-gay-50 w-full elative">
  <x-action-message on="adquirenteCreated" class="  absolute from-green-700 to-green-900 border-green-700   top-0 right-0 z-50 shadow-lg shadow-green-500/60"> Adquirente creado con exitó.</x-action-message> 
  <x-action-message on="adquirenteUpdated" class="  absolute from-orange-600 to-orange-800 border-orange-600   top-0 right-0 z-50 shadow-lg shadow-ornge-500/60" >Adquirente actualizado con exitó.</x-action-message> 
  <x-action-message on="adquirenteDeleted" class="  absolute from-red-700 to-red-900 border-red-700   top-0 right-0 z-50 shadow-lg shadow-red-500/60" >Adquirente eliminado con exitó.</x-action-message> 

  <x-action-message on="autorizadoCreated" class="  absolute from-yellow-700 to-yellow-900 border-yellow-700   top-0 right-0 z-50 shadow-lg shadow-yellow-500/60" >Autorizado agregado con exitó.</x-action-message> 
        ...
        <div class="">
              <div class="w-full flex item-center justify-between order-4  lg:flex-row lg:items-center  mx-auto bg-gray-300 lg:py-4  py-2 lg:px-6 px-3 rounded-md  shadow-md">
                    ...
                    <button class="border border-white hover:text-gray-200 hover:bg-green-700 bg-green-500 px-2 py-0.5 rounded-lg text-white text-sm h-7 place-self-center flex items-center gap-x-2 cursor-pointer"    wire:click="option('save')" title="Agregar comitente"> 
                                      ...
                                      <div class="min-w-full inline-block align-middle ">                                      
                                          <div class="overflow-hidden">
                                            ...
                                            @if (count($adquirentes) )
                                                    ...
                                                    <tr class="divide-x-2 divide-y-2 divide-gray-400 [&>td]:pl-2 [&>td]:pr-1 [&>td]:lg:pl-4 [&>td]:text-start ">
                                                      ...
                                                      <td >
                                                        <div class="flex justfy-end lg:gap-x-6 gap-x-4 text-white text-xs">
                                                          ...
                                                          <button 
                                                              class=" hover:text-gray-200  hover:bg-yellow-900 flex items-center py-0.5 bg-yellow-800 rounded-lg px-1 cursor-pointer" wire:click="option('autorizados',{{$comitente->id}})" title="Ver autorizados">
                                                                <svg width="20px" height="18px"  fill="none" viewBox="0 0 512 512"  xml:space="preserve">   	 
                                                                  <g>
                                                          ...
                                                          <button 
                                                              class=" hover:text-gray-200  hover:bg-green-900 flex items-center py-0.5 bg-green-800 rounded-lg px-1 cursor-pointer" wire:click="option('view',{{$comitente->id}})" title="Ver comitente">
                                                          ...
                                                          <button 
                                                              class=" hover:text-gray-200  hover:bg-red-700 flex items-center py-0.5 bg-red-600 rounded-lg px-1 cursor-pointer" wire:click="option('delete',{{$comitente->id}})">
                                                      ...
                                                      <button class=" hover:text-gray-200 hover:bg-orange-700 flex items-center py-0.5 bg-orange-600 rounded-lg px-1 cursor-pointer" wire:click="option('update',{{$comitente->id}})" >
                                                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              <h3 class="w-full text-center py-8 px-3 rounded-md text-xl">¡Sin resultados para "<strong>{{$query}}</strong>"!</h3>
                                              @endif
                                          </div>
