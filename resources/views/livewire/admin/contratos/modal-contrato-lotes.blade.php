<x-modal class="lg:max-w-[90%] lg:w-auto ">
    ...
    <div class="flex  flex-col justify-center items-center  h-full max-h-[90vh]">
        <h2
        ...
        <div class="overflow-x-auto w-full">
            ...
            <div class=" overflo-y-auto w-full px-4 py-2 bg-gray-100 rounded-lg mb-4  ">
                                    ...
                                    <td>
                                        @if (in_array($item['estado'] ?? null, ['disponible', 'standby']) &&
                                            ...
                                            <input type="checkbox" value="{{ $item['id'] }}"
                                                wire:model="selectedToMove" class="size-4 accent-blue-700">
                                        @else
            ...
            <div
                class="md:flex grid grid-cols-2   md:justify-center justify-between  lg:text-base text-xs  text-white  flex-wrap gap-x-4 gap-y-2 md:gap-x-12  w-full  py-2  md:px-4 px-2 overflow-y-aut">


                <button type="button"
                    class="bg-orange-600 hover:bg-orange-700 md:mt-2 rounded-lg md:px-2 px-1.5 lg:py-1 py-0.5 flex text-center items-center justify-center "
                ...
                <button
                    class="bg-green-600 hover:bg-green-700 md:mt-2 rounded-lg md:px-2 px-1.5 lg:py-1 py-0.5 flex text-center items-center justify-center "
                    wire:click="save">
                    Guardar
                </button>
                ...
                <button
                    class="bg-cyan-700 hover:bg-cyan-800 md:mt-2 rounded-lg md:px-2 px-1.5 lg:py-1 py-0.5 flex text-center items-center justify-center "
                    wire:click="save(true)">
                    Guardar y enviar mail
                </button>

                <button
                    class="bg-blue-600 hover:bg-blue-700 md:mt-2 rounded-lg md:px-4 px-2 lg:py-1 py-0.5 flex text-center items-center justify-center "
