                ...
                <article
                    ...
                    <div
                        ...
                        <div class="flex flex-col   lg:px-4 mb-3">
                            ...
                            <p class="text-pretty lg:text-center text-start">Para poder ofertar necesitás abonar un
                                seguro
                                reembolsable
                        ...
                        <div class="flex flex-col   lg:px-4 mb-3">
                            ...
                            <p class="text-pretty lg:text-center text-start">Si al terminar la subasta nadie más ofrece,
                                el
                                producto es
                                tuyo.
                        ...
                        <div class="flex flex-col   lg:px-4">
                            ...
                            <p class="text-pretty lg:text-center text-start">Todo es online: mirás, ofertás y pagás
                                desde
                                donde estés.
