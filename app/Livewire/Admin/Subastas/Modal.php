...
class Modal extends Component
{
    ...
    public function update()
    {
        ...
        if (! $this->subasta) {
            ...
            info(['pausar' => $this->pausar]);
            // pausa prox
            if ($this->subasta->estado == SubastaEstados::INACTIVA && $this->pausar) {
                $this->subasta->estado = SubastaEstados::PAUSADA_PROX;
            } elseif ($this->subasta->estado == SubastaEstados::PAUSADA_PROX && $this->pausar) {
                $this->subasta->estado = SubastaEstados::INACTIVA;
            }
